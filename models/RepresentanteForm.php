 ...
 */
class RepresentanteForm extends Model
{
    public $id;
    public $nombre;
    public $apellido;
    ...
    {
        return [                        
            [['nombre', 'apellido','nro_documento'], 'required'],
            [['id'], 'integer'],
    ...
    /**
     * Se serializa los datos Persona para ser mostrados.
     ...
     */
    public function obtenerRepresentante($id = null){
